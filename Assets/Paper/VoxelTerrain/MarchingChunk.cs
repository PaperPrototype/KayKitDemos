...
public class MarchingChunk : VoxelChunkBase
{
    ...
    public override void Initialize(Int3 chunkPos, VoxelWorld world)
    {
        voxelWorld = world;
    ...
    private byte SampleWorld(int localX, int localY, int localZ)
    {
        ...
        return voxelWorld.GetVoxel(new Int3(worldX, localY, worldZ));
    }
}
